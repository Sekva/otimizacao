...
\hspace{0.8cm}
%TODO: Diferenciabilidade
%TODO: Pontos extremos
%TODO: Jacobiana, Hensiana, uso do polinomio de tailor para duas variaveis
%TODO: Aproximação usando o limite
...
otimizados, e a saída da função não necessariamente ser um valor único.
Portanto, agora temos a necessidade de trabalharmos com funções que tanto na
entrada como na saída, se utilizam de vetores contendo um ou mais valores.
Dai temos a necessidade de estender as ferramentas criadas para funções em uma
variável, para funções de várias variáveis, que formalmente se apresenta
da seguinte forma:
...
torna-se um pouco mais difícil decidir qual a melhor saída. Sendo
